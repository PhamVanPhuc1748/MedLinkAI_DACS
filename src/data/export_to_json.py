...
def _export_users(session, store) -> int:
    ...
    store.users.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_drugs(session, store) -> int:
    ...
    store.drugs.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_diseases(session, store) -> int:
    ...
    store.diseases.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_proteins(session, store) -> int:
    ...
    store.proteins.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_drug_disease_links(session, store) -> int:
    ...
    store.drug_disease_links.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_drug_protein_links(session, store) -> int:
    ...
    store.drug_protein_links.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_protein_disease_links(session, store) -> int:
    ...
    store.protein_disease_links.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_prediction_history(session, store) -> int:
    ...
    store.prediction_history.replace_all(records, sync_to_db=False)
    return len(records)
...
def _export_dataset_tables(session, store) -> dict[str, int]:
    ...
    for model_cls, tbl, to_dict in mapping:
        ...
        tbl.replace_all(records, sync_to_db=False)
